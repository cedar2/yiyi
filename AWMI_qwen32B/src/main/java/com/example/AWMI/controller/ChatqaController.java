...
//        }
        ...
        public Result getByConversation(@PathVariable Integer conversationId) {
                List<Map<String, Object>> result = chatqaService.getModelAnswersByConversationId(conversationId);
